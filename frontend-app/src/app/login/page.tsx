    ...
    <div style={{ minHeight: '100vh', background: '#f3f4f6', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        <div style={{ width: '100%', maxWidth: '420px', background: '#fff', borderRadius: '16px', padding: '40px 36px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 700, color: '#0f1729', textAlign: 'center', marginBottom: '6px' }}>Welcome back</h1>
          <p style={{ fontSize: '13px', color: '#6b7280', textAlign: 'center', marginBottom: '28px' }}>Sign in to your CareerNav account</p>

          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div>
              <label htmlFor="email" style={{ display: 'block', fontSize: '12px', fontWeight: 500, color: '#374151', marginBottom: '6px' }}>
                Email address
              </label>
              <input
                id="email"
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                <label htmlFor="password" style={{ fontSize: '12px', fontWeight: 500, color: '#374151' }}>
                  Password
                </label>
                <button
                  type="button"
                  onClick={() => setShowForgot(true)}
                  style={{ fontSize: '12px', color: '#2255ec', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
                >
                  Forgot password?
                </button>
              </div>
            ...
            <button
              ...
              style={{
                ...
                transition: 'background 150ms', marginTop: '4px',
              }}
            >
          ...
          <div style={{ marginTop: '20px', padding: '12px', borderRadius: '10px', background: '#f3f4f6', display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
            ...
            <div>
              <p style={{ fontSize: '12px', fontWeight: 600, color: '#0f1729', marginBottom: '2px' }}>Secure authentication</p>
              <p style={{ fontSize: '11px', color: '#6b7280' }}>Your data is private and only accessible to you.</p>
            </div>
          </div>
      ...
      {showForgot && (
        <div style={{
          ...
          <div style={{ background: '#fff', borderRadius: '16px', padding: '32px', width: '100%', maxWidth: '400px', boxShadow: '0 20px 40px rgba(0,0,0,0.15)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
              <div style={{ width: '36px', height: '36px', borderRadius: '8px', background: 'rgba(34,85,236,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Lock size={16} style={{ color: '#2255ec' }} />
              </div>
              <h2 style={{ fontSize: '16px', fontWeight: 700, color: '#0f1729' }}>Forgot Password</h2>
            </div>
            ...
            {!forgotSent ? (
                ...
                <form onSubmit={handleForgot} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px' }}>
                    <button
                      ...
                      style={{ flex: 1, padding: '10px', borderRadius: '8px', border: '1px solid #e5e7eb', background: '#fff', fontSize: '13px', cursor: 'pointer', color: '#374151' }}
                    >
                      Cancel
                    </button>
                    <button
              ...
              <div style={{ textAlign: 'center', padding: '16px 0' }}>
                ...
                <p style={{ fontSize: '13px', color: '#374151', marginBottom: '4px', fontWeight: 600 }}>Check your email</p>
                <p style={{ fontSize: '12px', color: '#6b7280', marginBottom: '20px' }}>Reset instructions sent to <strong>{forgotEmail}</strong></p>
                <button
                  onClick={() => { setShowForgot(false); setForgotSent(false); setForgotEmail(''); }}
