    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: "15px", fontWeight: 700, color: "#0f1729" }}>
            AICareerNav
          </span>
        </Link>
        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          ...
          <Link
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.borderColor = "#2255ec")
            }
            onMouseLeave={(e) =>
          ...
          <div>
            ...
            >
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = "#1a44c8")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.background = "#2255ec")
                }
              >
            ...
            <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
              {["No credit card", "Powered by GroqAI", "Available 24/7"].map(
                (t) => (
                  <span
                    key={t}
                    style={{
          ...
          <div style={{ position: "relative", height: "440px" }}>
            ...
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg,rgba(34,85,236,0.06),rgba(5,150,105,0.06))",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: "72px",
      ...
      <section style={{ padding: "80px 48px", background: "#fff" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "56px" }}>
            ...
            >
              Six Tools to{" "}
              <span style={{ color: "#2255ec" }}>Career Success</span>
            </h2>
            <p
              style={{
                fontSize: "15px",
            ...
            >
              From resume analysis to AI career coaching — everything you need
              to land your next role, all in one platform.
            </p>
          </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    transition:
                      "box-shadow 200ms, transform 200ms, border-color 200ms",
                  }}
                  onMouseEnter={(e) => {
      ...
      >
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              One Click,{" "}
              <span style={{ color: "#059669" }}>Every Major Portal</span>
            </h2>
            <p
              style={{
                fontSize: "15px",
            ...
            >
              We generate smart search links for the job sites you actually use
              — your role and location pre-filled, one click opens each in a new
              tab.
            </p>
          </div>
          <div
          ...
          >
            ...
            <br />
            You apply on the original site — we don&apos;t store applications or
            charge fees.
          </p>
      ...
      >
        ...
        >
          ...
          >
            Ready to{" "}
            <span style={{ color: "#2255ec" }}>Navigate Your Career</span>?
          </h2>
          <p
            style={{ fontSize: "15px", color: "#6b7280", marginBottom: "32px" }}
          >
            Analyze your resume, discover career paths, track your progress, and
            chat with AI — start your journey today.
          </p>
          <button
            onClick={() => router.push("/login")}
            style={{
